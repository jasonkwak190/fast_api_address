...
# 출처 : https://business.juso.go.kr/addrlink/attrbDBDwld/attrbDBDwldList.do?cPath=99MD&menu=%EB%8F%84%EB%A1%9C%EB%AA%85%EC%A3%BC%EC%86%8C%20%ED%95%9C%EA%B8%80#this

@router.get("/download_address_csv/{da_date}")
async def download_and_extract(da_date: str):
    ...
    try:
        ...
        with open("merged_data.csv", "w", encoding="UTF-8") as output_file:
            ...
            # 각 파일을 순회하며 데이터 읽기
            for file_name in os.listdir("extracted_data"):
